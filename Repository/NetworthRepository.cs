        ...
        public static List<PortFolioDetails> _portFolioDetails = new List<PortFolioDetails>()
            {
                new PortFolioDetails{
                    ...
                    {
                        new MutualFundDetails{MutualFundName = "Axis Small Cap Fund Direct-Growth", MutualFundUnits=44},
                        new MutualFundDetails{MutualFundName = "Quant Small Cap Fund Direct Plan-Growth", MutualFundUnits=66}
                    },
                ...
                new PortFolioDetails
                {
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        new MutualFundDetails{MutualFundName = "Axis Small Cap Fund Direct-Growth", MutualFundUnits=34},
                        new MutualFundDetails{MutualFundName = "Quant Small Cap Fund Direct Plan-Growth", MutualFundUnits=566}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 240, StockName = "HDFC"},
                        new StockDetails{StockCount = 46, StockName = "Asian Paints"}
                    }
                },
                new PortFolioDetails
                {
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        new MutualFundDetails{MutualFundName = "Kotak Small Cap Fund Direct-Growth", MutualFundUnits=8},
                        new MutualFundDetails{MutualFundName = "Axis Small Cap Fund Direct-Growth", MutualFundUnits=6},
                        new MutualFundDetails{MutualFundName = "Quant Small Cap Fund Direct Plan-Growth", MutualFundUnits=6}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 20, StockName = "Asian Paints"},
                        new StockDetails{StockCount = 34, StockName = "AXIS"},
                    ...
                    if (portFolioDetails.StockList != null && portFolioDetails.StockList.Any() == true)
                    {
                        foreach (StockDetails stockDetails in portFolioDetails.StockList)
                        {
                            if (stockDetails.StockName != null)
                            {
                                ...
                                Console.WriteLine(stock);
                                networth.Networth += stockDetails.StockCount * stock.StockPrice;
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    if (portFolio.StockList != null || portFolio.MutualFundList.Any() != false)
                    {
                        foreach (StockDetails stockDetails in portFolio.StockList)
                        {
                            ...
                            networth += stockDetails.StockCount * stock.StockPrice;
                        }
                    }
